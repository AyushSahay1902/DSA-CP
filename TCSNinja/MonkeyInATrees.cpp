...
Note: Kindly follow the order of inputs as n,k,j,m,p as given in the above example. And output must include the same format as in above
*/
...
int main() {
    ...
    int eatable_bananas = m / k;
    int eatable_peanuts = p / j;
    int total_eatable = eatable_bananas + eatable_peanuts;

    int monkeys_remaining = (total_eatable >= n) ? 0 : n - total_eatable;

    cout << monkeys_remaining << endl;
